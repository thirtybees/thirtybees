...
Pour installer thirty bees, vous avez besoin d'un serveur web distant ou sur votre ordinateur (MAMP), avec un accès à une base de données de type MySQL.
...
Merci d'avoir télécharger et d'utiliser thirty bees, solution e-commerce open-source !
