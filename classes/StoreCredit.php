...
class StoreCreditCore extends ObjectModel
{
    ...
    protected $webserviceParameters = [
        ...
        'associations'    => [
            'store_credit_spends' => ['getter' => 'getUsageWs', 'resource' => 'store_credit_spends'],
        ]
    ];
     ...
     * @throws PrestaShopException
     */
    public function getUsageWs(): array
    {
        return array_map('intval', array_column(StoreCreditSpend::getSpendsForCredit((int)$this->id), 'id_store_credit_spend'));
    }
}
