...
//            $pathToImage = false;
    ...
    public function display()
    {
        ...
        $c = '<pre>'.print_r($this->context->cookie->getAll(), true).'</pre>';

        $this->context->smarty->assign(
            [
                'page'   => $this->json ? json_encode($page) : $page . $c,
    ...
    protected function resolveValueType(string $fieldId, array $listField): ValueType
    {
        ...
        switch (strtolower($type)) {
            ...
            case HelperList::COLUMN_TYPE_DATETIME:
                // this is not a bug, filters in list does not support time component of datetime
                return DatetimeValueType::date();
