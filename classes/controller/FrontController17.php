...
/*
 * This trait extends FrontController with methods required for PS 1.7 theme
 * compatibility. One of the biggest distinctions between 30bz/PS 1.6 themes
 * and PS 1.7 themes is the set of variables passed to Smarty templates. The
 * set is entirely different, not one equal variable can be found in both sets.
 */

trait FrontController17
{
...
//            [_PS_THEME_DIR_, _PS_PARENT_THEME_DIR_, _PS_ROOT_DIR_],
...
//    {
//        if (!in_array(Tools::getRemoteAddr(), ['localhost', '127.0.0.1'])) {
