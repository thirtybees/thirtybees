...
class OrderInvoiceCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields'  => [
            ...
            'total_discount_tax_excl'         => ['type' => self::TYPE_FLOAT, 'validate' => 'isPrice'],
            'total_discount_tax_incl'         => ['type' => self::TYPE_FLOAT, 'validate' => 'isPrice'],
            'total_paid_tax_excl'             => ['type' => self::TYPE_FLOAT, 'validate' => 'isPrice'],
            'total_paid_tax_incl'             => ['type' => self::TYPE_FLOAT, 'validate' => 'isPrice'],
            'total_products'                  => ['type' => self::TYPE_FLOAT, 'validate' => 'isPrice'],
            'total_products_wt'               => ['type' => self::TYPE_FLOAT, 'validate' => 'isPrice'],
