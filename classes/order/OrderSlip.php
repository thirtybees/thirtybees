...
class OrderSlipCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields'  => [
            ...
            'total_products_tax_excl' => ['type' => self::TYPE_FLOAT, 'validate' => 'isPrice', 'required' => true],
            'total_products_tax_incl' => ['type' => self::TYPE_FLOAT, 'validate' => 'isPrice', 'required' => true],
            'total_shipping_tax_excl' => ['type' => self::TYPE_FLOAT, 'validate' => 'isPrice', 'required' => true],
            'total_shipping_tax_incl' => ['type' => self::TYPE_FLOAT, 'validate' => 'isPrice', 'required' => true],
            'amount'                  => ['type' => self::TYPE_FLOAT, 'validate' => 'isPrice'],
            'shipping_cost'           => ['type' => self::TYPE_INT],
            'shipping_cost_amount'    => ['type' => self::TYPE_FLOAT, 'validate' => 'isPrice'],
