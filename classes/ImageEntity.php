...
class ImageEntityCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields'  => [
            ...
            'classname'     => ['type' => self::TYPE_STRING, 'required' => true, 'size' => 64], // Todo: Datakick -> maybe there needs to be a validation!?
        ],
        'keys' => [
            'image_entity' => [
     ...
     */
    // Todo: Datakick/Genzo -> decide when this function should be called (atm it's in AdminController (needed for modules) and in ObjectModel::initializationCallback (core))
