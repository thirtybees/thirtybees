        ...
        $this->fields_options = [
            'products'            => [
                ...
                'fields' => [
                    ...
                    'PS_PRODUCT_ACCESSORIES_RECIPROCAL' => [
                        'title'      => $this->l('Create reciprocal product accessories'),
                        'hint'       => $this->l('When enabled, associating product A with product B will also associate product B with product A.'),
                        'validation' => 'isBool',
                        'cast'       => 'intval',
                        'required'   => false,
                        'type'       => 'bool',
