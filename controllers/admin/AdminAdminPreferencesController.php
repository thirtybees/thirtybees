        ...
        $this->fields_options = [
            'general'       => [
                ...
                'fields' => [
                    ...
                    'PS_BO_AUTOLOGOUT_TIMER' => [
                        'title'      => $this->l('Log out employees after being inactive for'),
                        'hint'       => $this->l('Set the amount of seconds after which an employee is automatically logged out from the back office, 0 to disable.'),
                        'validation' => 'isInt',
                        'cast'       => 'intval',
                        'type'       => 'text',
