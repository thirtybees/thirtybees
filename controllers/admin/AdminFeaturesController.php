        ...
        $this->fields_form = [
            ...
            'input'  => [
                ...
                [
                    ...
                    'lang'     => true,
                    'size'     => 33,
                    'hint'     => $this->l('This prefix value will be display before the actual value. Typical example: ca.'),
                    'required' => false,
                ],
                [
                    'type'     => 'text',
                    ...
                    'lang'     => true,
                    'size'     => 33,
                    'hint'     => $this->l('This suffix value will be display after the actual value. Units are typical examples: kg'),
                    'required' => false,
                ],
                [
                    'type'     => 'switch',
