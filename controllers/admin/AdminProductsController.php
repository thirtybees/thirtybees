            ...
            if ($this->product_exists_in_shop) {
                ...
                $data->assign(
                    [
                        ...
                        'imageExtension'      => ImageManager::getDefaultImageExtension(false), // Todo: Datakick -> this is a good example that ajax calls can fail with webp (if $checkSupport=true) -> Maybe there is a better solution
                    ]
                );
            } else {
