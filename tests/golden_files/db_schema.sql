...
CREATE TABLE `PREFIX_carrier` (
  ...
  `min_total` decimal(20,6) DEFAULT '0.000000',
  `min_total_tax` tinyint(1) NOT NULL DEFAULT '0',
  `max_total` decimal(20,6) DEFAULT '0.000000',
  `max_total_tax` tinyint(1) NOT NULL DEFAULT '0',
  `min_weight` decimal(20,6) DEFAULT '0.000000',
...
CREATE TABLE `PREFIX_cart_rule` (
  ...
  `minimum_amount_product_restriction` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `shop_restriction` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `free_shipping` tinyint(1) NOT NULL DEFAULT '0',
  `reduction_percent` decimal(5,2) NOT NULL DEFAULT '0.00',
  `reduction_max` decimal(20,6) NOT NULL DEFAULT '0.000000',
  `reduction_max_tax` tinyint(1) NOT NULL DEFAULT '0',
  `reduction_max_currency` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `PREFIX_contact` (
  ...
  `active` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `send_confirm` tinyint(1) unsigned NOT NULL DEFAULT '1',
...
CREATE TABLE `PREFIX_order_detail` (
  ...
  `product_reference` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_supplier_reference` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `PREFIX_order_state_lang` (
  ...
  `email_subject` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `PREFIX_product` (
  ...
  `supplier_reference` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `active` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `redirect_type` enum('','404','301','302','301-category','302-category') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `hs_code` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `country_of_origin` int(11) unsigned NOT NULL DEFAULT '0',
  `age_verification` tinyint(1) NOT NULL DEFAULT '0',
  `dangerous_goods` tinyint(1) NOT NULL DEFAULT '0',
  `un_number` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `hazard_class` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `packing_group` enum('','I','II','III') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `PREFIX_product_supplier` (
  ...
  `product_supplier_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_supplier_reference` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_supplier_price_te` decimal(20,6) NOT NULL DEFAULT '0.000000',
  `product_supplier_comment` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_currency` int(11) unsigned NOT NULL,
...
CREATE TABLE `PREFIX_supply_order_detail` (
  ...
  `id_product_attribute` int(11) unsigned NOT NULL,
  `reference` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `supplier_reference` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ean13` varchar(13) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `upc` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
