...
class CartPackageListTest extends \Codeception\Test\Unit
{
    ...
    private function verify($expectedAddressList, $actualAddressList)
    {
        ...
        $this->assertEquals($addressCnt, count($actualAddressList), "Cart should be split into $addressCnt addresses");
        ...
        foreach ($expectedAddressList as $addressId => $expectedPackageList) {
            ...
            $this->assertEquals($packageCnt, count($actualPackageList), "Cart should be split into $packageCnt packages");
