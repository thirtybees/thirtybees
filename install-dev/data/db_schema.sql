...
CREATE TABLE `PREFIX_order_detail_tax` (
  ...
  `unit_amount`     DECIMAL(20, 6) NOT NULL DEFAULT 0,
...
CREATE TABLE `PREFIX_referrer` (
  ...
  `base_fee`                DECIMAL(20, 6)   NOT NULL DEFAULT 0,
  `percent_fee`             DECIMAL(5, 2)    NOT NULL DEFAULT 0,
  `click_fee`               DECIMAL(20, 6)   NOT NULL DEFAULT 0,
  `date_add`                DATETIME         NOT NULL,
...
CREATE TABLE `PREFIX_stock_mvt` (
  ...
  `price_te`            DECIMAL(20, 6)            DEFAULT 0,
  `last_wa`             DECIMAL(20, 6)            DEFAULT 0,
  `current_wa`          DECIMAL(20, 6)            DEFAULT 0,
...
CREATE TABLE `PREFIX_supply_order` (
  ...
  `total_te`               DECIMAL(20, 6)            DEFAULT 0,
  `total_with_discount_te` DECIMAL(20, 6)            DEFAULT 0,
  `total_tax`              DECIMAL(20, 6)            DEFAULT 0,
  `total_ti`               DECIMAL(20, 6)            DEFAULT 0,
  `discount_rate`          DECIMAL(20, 6)            DEFAULT 0,
  `discount_value_te`      DECIMAL(20, 6)            DEFAULT 0,
...
CREATE TABLE `PREFIX_supply_order_detail` (
  ...
  `ean13`                         VARCHAR(13)               DEFAULT NULL,
  `upc`                           VARCHAR(12)               DEFAULT NULL,
  `exchange_rate`                 DECIMAL(20, 6)            DEFAULT 0,
  `unit_price_te`                 DECIMAL(20, 6)            DEFAULT 0,
  `quantity_expected`             INT(11) UNSIGNED NOT NULL,
  `quantity_received`             INT(11) UNSIGNED NOT NULL,
  `price_te`                      DECIMAL(20, 6)            DEFAULT 0,
  `discount_rate`                 DECIMAL(20, 6)            DEFAULT 0,
  `discount_value_te`             DECIMAL(20, 6)            DEFAULT 0,
  `price_with_discount_te`        DECIMAL(20, 6)            DEFAULT 0,
  `tax_rate`                      DECIMAL(20, 6)            DEFAULT 0,
  `tax_value`                     DECIMAL(20, 6)            DEFAULT 0,
  `price_ti`                      DECIMAL(20, 6)            DEFAULT 0,
  `tax_value_with_order_discount` DECIMAL(20, 6)            DEFAULT 0,
  `price_with_order_discount_te`  DECIMAL(20, 6)            DEFAULT 0,
...
CREATE TABLE `PREFIX_product_supplier` (
  ...
  `id_supplier`                INT(11) UNSIGNED NOT NULL,
  `product_supplier_reference` VARCHAR(32)               DEFAULT NULL,
  `product_supplier_price_te`  DECIMAL(20, 6)   NOT NULL DEFAULT 0,
  `id_currency`                INT(11) UNSIGNED NOT NULL,
