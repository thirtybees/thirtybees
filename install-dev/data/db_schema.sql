...
CREATE TABLE `PREFIX_order_detail_tax` (
  ...
  `unit_amount`     DECIMAL(20, 6) NOT NULL DEFAULT '0.00',
  `total_amount`    DECIMAL(20, 6) NOT NULL DEFAULT '0.00',
  KEY (`id_order_detail`),
  KEY `id_tax` (`id_tax`)
)
  ENGINE = InnoDB
...
CREATE TABLE `PREFIX_order_detail` (
  ...
  `ecotax`                        DECIMAL(20, 6)      NOT NULL DEFAULT '0.00',
...
CREATE TABLE `PREFIX_order_cart_rule` (
  ...
  `value_tax_excl`     DECIMAL(20, 6)   NOT NULL DEFAULT '0.00',
  `free_shipping`      TINYINT(1)       NOT NULL DEFAULT '0',
...
CREATE TABLE `PREFIX_referrer` (
  ...
  `base_fee`                DECIMAL(20, 6)   NOT NULL DEFAULT '0.00',
  `percent_fee`             DECIMAL(5, 2)    NOT NULL DEFAULT '0.00',
  `click_fee`               DECIMAL(20, 6)   NOT NULL DEFAULT '0.00',
  `date_add`                DATETIME         NOT NULL,
