...
$products = [
    ...
    'Short_Sleeve_T-shirts'       => [
        'Color' => ['Green'],
        'Size'  => ['S', 'M', 'L'],
    ],
    'Faded_Short_Sleeve_T-shirts' => [
        'Color' => ['Orange', 'Blue'],
        'Size'  => ['S', 'M', 'L'],
    ],
    'Cami_Tank_Top'               => [
    ...
    'Printed_Summer_Dress_1'      => [
        'Color' => ['Yellow', 'Blue', 'Orange', 'Black'],
        'Size'  => ['S', 'M', 'L'],
    ],
    'Long_Printed_Dress'          => [
        'Color' => ['Grey'],
