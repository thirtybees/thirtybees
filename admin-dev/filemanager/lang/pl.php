...
define('lang_Text_filter', 'wpisz tekst');
...
define('lang_Extract', 'Rozpakuj');
define('lang_File_info', 'Info o pliku');
define('lang_Edit_image', 'Edytuj zdjęcie');
define('lang_Duplicate', 'Duplikuj');
