...
{foreach from=$css_files key=css_uri item=media}
	{if $css_uri == 'lteIE9'}
		...
		<link rel="stylesheet" href="{$css_uriie9|escape:'html':'UTF-8'}?version={$smarty.const._TB_VERSION_}" type="text/css" media="{$mediaie9|escape:'html':'UTF-8'}" />
		{/foreach}
		<![endif]-->
	{else}
		<link rel="stylesheet" href="{$css_uri|escape:'html':'UTF-8'}?version={$smarty.const._TB_VERSION_}" type="text/css" media="{$media|escape:'html':'UTF-8'}" />
	{/if}
{/foreach}
{/if}
