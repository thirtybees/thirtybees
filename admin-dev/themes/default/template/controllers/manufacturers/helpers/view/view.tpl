		...
		{if !$product.combinations}
			<div class="panel">
				<div class="panel-heading">
					...
					<div class="pull-right">
						<a href="{$product.link|escape:'html'}" class="btn btn-default btn-sm">
							<i class="icon-edit"></i> {l s='Edit'}
						</a>
						<a href="{$product.deleteLink|escape:'html'}" class="btn btn-default btn-sm" onclick="return confirm('{l s='Delete product #'}{$product.id} ?');">
