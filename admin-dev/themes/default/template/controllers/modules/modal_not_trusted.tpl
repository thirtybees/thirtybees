...
<div class="untrusted-content-action">
	...
	<div class="modal-body">
		<div class="alert alert-warning">
			<h3>{l s='Do you want to install this module that could not be verified by thirty bees?'}</h3>
	...
	<div class="modal-footer">
		<div class="alert alert-info">
			<p>
				{l s='Since you may not have downloaded this module from thirty bees Addons, we cannot assert that the module is not adding some undisclosed functionalities. We advise you to install it only if you trust the source of the content.'}
