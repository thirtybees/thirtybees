	...
	<div class="form-group">
		<label class="control-label col-lg-2 col-lg-offset-1">
			<span class="label-tooltip" data-toggle="tooltip"
				title="{l s='Calculated from the package width, height and depth above. For reference: a shoe box is about 10 dm3, a moving box about 60 dm3, a pallet about 1500 dm3 (1 dm3 = 1 litre).'}">
				{l s='Package volume'}
			</span>
		</label>
		<div class="col-lg-9">
...
<script>
	$(function () {
		...
		// decimal separator follows the employee language (comma in most of
		// Europe, point in the US); trailing zeros are dropped
		...
		const render = () => {
			...
			if (!factor) {
				...
				$volume.text(number(raw, 2) + ' ' + unit + cubic);
				return;
			}
