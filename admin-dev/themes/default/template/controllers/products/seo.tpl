	...
	<div class="row">
		<div class="col-lg-9 col-lg-offset-3">
			...
			<div class="alert alert-warning translatable-field lang-{$language.id_lang}">
				...
				{if $useRoutes}
					<strong>{if isset($rewritten_links[$language.id_lang][0])}{$rewritten_links[$language.id_lang][0]|escape:'html':'UTF-8'}{/if}<span id="friendly-url_{$language.id_lang}">{if isset($product->link_rewrite[$language.id_lang])}$product->link_rewrite[$language.id_lang]|escape:'html':'UTF-8'}{/if}</span>{if isset($rewritten_links[$language.id_lang][1])}{$rewritten_links[$language.id_lang][1]|escape:'html':'UTF-8'}{/if}</strong>
				{else}
					<strong>{if isset($rewritten_links[$language.id_lang][0])}{$rewritten_links[$language.id_lang][0]|escape:'html':'UTF-8'}{/if}</strong>
				{/if}
			</div>
			{/foreach}
		</div>
