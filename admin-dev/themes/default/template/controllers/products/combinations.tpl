				...
				<ul id="id_image_attr" class="list-inline">
					...
					<li>
						...
						<label for="id_image_attr_{$image.id_image}">
							<img class="img-thumbnail" src="{$smarty.const._THEME_PROD_DIR_}{$image.obj->getExistingImgPath()}-{$imageType}.{$imageExtension}" alt="{$image.legend|escape:'html':'UTF-8'}" title="{$image.legend|escape:'html':'UTF-8'}" />
						</label>
					</li>
					{/foreach}
				</ul>
