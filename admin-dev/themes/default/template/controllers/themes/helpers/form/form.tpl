	...
	<div class="defaultForm form-horizontal">
			...
			<div class="panel" id="">
				...
				<div class="form-wrapper">
					<div class="form-group">
						<p>{l s='To add a new theme, simply connect to your thirty bees Addons account: your new theme will be automatically imported to your shop.'}</p>
		...
		{/if}
			...
			<div class="alert alert-info">
				...
				<p>{l s='Please note that for security reasons, you can only add themes that are being distributed on thirty bees Addons, the official marketplace.'}</p>
